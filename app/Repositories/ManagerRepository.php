...
class ManagerRepository extends BaseRepository
{
    ...
    //confirmationToken是否存在
    public function confirmationTokenExist($confirmation_token)
    {
        return (bool)Manager::where('confirmation_token',$confirmation_token)->count();
    } 

    public function confirmationTokenByMg($confirmation_token)
    {
        return Manager::where('confirmation_token',$confirmation_token)->first();
    }

    public function ManagerByMgAddConfirmationToken($mg_name)
    {
        $mg = Manager::where('mg_name',$mg_name)->first();
        if(is_null($mg)){
            return false;
        }
